...
public class MenuVendedor extends javax.swing.JDialog {
     ...
     */
    public MenuVendedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Registrar Nueva Pieza");

        jButton2.setText("Mostrar Pieza");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MenuVendedor dialog = new MenuVendedor(new javax.swing.JFrame(), true);
